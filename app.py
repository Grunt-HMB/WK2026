...
menu_items = ["Groepsfase", "Mijn voorspellingen", "Scorebord", "Reglement"]
...
if menu == "Groepsfase":
    ...
    show_scoreboard(users_df, matches_df, predictions_df, results_df)
...
st.markdown('<div class="footer-line">WK 2026 Pronostiek © 2026</div>', unsafe_allow_html=True)
